...
template <unsigned int N>
HW_FORCE_INLINE u32 fnv_hash_template(const char (&str)[N])
{
	return (((((fnv_hash_template<N-3>(str) ^ str[N-3]) * 16777619u) ^ str[N-2]) * 16777619u) ^ str[N-1]) * 16777619u;
}

template<>
HW_FORCE_INLINE u32 fnv_hash_template<3>(const char (&str)[3])
{
	return (((((2166136261u ^ str[0]) * 16777619u) ^ str[1]) * 16777619u) ^ str[2]) * 16777619u;
}

template<>
HW_FORCE_INLINE u32 fnv_hash_template<2>(const char (&str)[2])
{
	return (((2166136261u ^ str[0]) * 16777619u) ^ str[1]) * 16777619u;
}

template<>
HW_FORCE_INLINE u32 fnv_hash_template<1>(const char (&str)[1])
{
	return (2166136261u ^ str[0]) * 16777619u;
}
...
HW_FORCE_INLINE u32 fnv_hash(const char (&str)[N])
{
	return fnv_hash_template<N, N>(str);
}
